...
selected_columns = ['salary', 'Age', 'GP', 'Min', 'PTS', 'FGM', 'FGA', 'FG%', '3PM', '3PA',
                    '3P%', 'FTM', 'FTA', 'FT%', 'OREB', 'DREB', 'REB', 'AST', 'TOV', 'STL','FP', 'BLK']
...
heatmap_fig, heatmap_ax = plt.subplots(figsize=(15, 2))  # Adjust the height based on the number of columns
sns.heatmap(salary_correlation, annot=True, cmap='coolwarm', fmt=".2f", linewidths=.5, ax=heatmap_ax)
...
ax1_aw.plot(player_rows_aw['season'], player_rows_aw['salary'], color=color, marker='o', label='Salary')
...
ax2_aw.plot(player_rows_aw['season'], player_rows_aw['FTA'], color=color, marker='o', label='FTA')
ax2_aw.plot(player_rows_aw['season'], player_rows_aw['FTM'], color='orange', marker='o', label='FTM')
...
ax1_jp.plot(player_rows_jp['season'], player_rows_jp['salary'], color=color, marker='o')
...
ax2_jp.plot(player_rows_jp['season'], player_rows_jp['PTS'], color=color, marker='o')
